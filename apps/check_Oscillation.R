...
#' @Description
#'
#' Function that checks value oscillation with day before and after. 
#'  
#'  
#' @Usage  
#'  
...
#' @Details
#'
#' Taking reference to a certain value defined this function will perform a check to see time evolution of that value
#' according with values from hour/day before and after.
#' 
#' @Author: Pedro Gomes
#'

oscil.check <- function(data_set,value = 10){
  
  # writes date of run in log file
  cat("Oscillation Check run on:", format(Sys.time(), "%a %d %b %Y %H:%M:%S"), '\n', file = "log.txt", sep = " ", append = TRUE)
